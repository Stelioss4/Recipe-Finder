...
namespace RecipeFinderWebApp.Migrations
{
    ...
    [Migration("20260410104955_AddWeeklyPlanShoppingListRelationToUser")]
    partial class AddWeeklyPlanShoppingListRelationToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IngredientUser", b =>
                {
                    ...
                    b.Property<int>("ShoppingListUsersId")
                        .HasColumnType("int");

                    b.HasKey("ShoppingListId", "ShoppingListUsersId");

                    b.HasIndex("ShoppingListUsersId");

                    b.ToTable("IngredientUser");
                });

            modelBuilder.Entity("IngredientUser1", b =>
                {
                    b.Property<int>("WeeklyPlanShoppingListId")
                        .HasColumnType("int");

                    b.Property<int>("WeeklyPlanShoppingListUsersId")
                        .HasColumnType("int");

                    b.HasKey("WeeklyPlanShoppingListId", "WeeklyPlanShoppingListUsersId");

                    b.HasIndex("WeeklyPlanShoppingListUsersId");

                    b.ToTable("IngredientUser1");
                });
            ...
            modelBuilder.Entity("Recipe_Finder.NutritionValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recipe_Finder.UserPreferences", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MaxCaloriesPerRecipe")
                        .HasColumnType("int");

                    b.Property<int?>("MaxPreparationTimeInMinutes")
                        .HasColumnType("int");

                    b.Property<int?>("PreferredFavoriteRecipesPerWeek")
                        .HasColumnType("int");

                    b.Property<int>("UserId")
                        .HasColumnType("int");

                    b.Property<int?>("WeeklyPlanDays")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IngredientUser", b =>
                {
                    ...
                    b.HasOne("Recipe_Finder.User", null)
                        .WithMany()
                        .HasForeignKey("ShoppingListUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("IngredientUser1", b =>
                {
                    b.HasOne("Recipe_Finder.Ingredient", null)
                        .WithMany()
                        .HasForeignKey("WeeklyPlanShoppingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Recipe_Finder.User", null)
                        .WithMany()
                        .HasForeignKey("WeeklyPlanShoppingListUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Recipe_Finder.NutritionValue", b =>
                {
                    b.HasOne("Recipe_Finder.Recipe", "Recipe")
                        ...
                        .HasForeignKey("Recipe_Finder.NutritionValue", "RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Recipe_Finder.UserPreferences", b =>
                {
                    b.HasOne("Recipe_Finder.User", "User")
                        ...
                        .HasForeignKey("Recipe_Finder.UserPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
